...
#ifdef CUDA_STUB
extern void run_3d_cpu_multi_species(const SimulationOptions3D &options);
...
#else
extern void run_3d_cuda_multi_species_impl(const SimulationOptions3D &options);
void run_3d_cuda_multi_species(const SimulationOptions3D &options) {
    run_3d_cuda_multi_species_impl(options);
}
#endif
